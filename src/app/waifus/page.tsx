...
export default function Waifus() {
  ...
  const newKeyVote = `${name}-${idDelVotante}`
  ...
  return (
    <main className="w-[100vw] h-[100vh]">
      ...
      <div className="overflow-y-scroll p-2 w-[100%] h-[90%] bg-[url(/snow.gif)] bg-no-repeat bg-cover font-[family-name:var(--font-geist-sans)]">
        ...
        {waifus.map((waifu) => {
          return (
            <div key={waifu.id} onClick={() => openModal(waifu.name, newKeyVote, waifu.id)} className="mt-4 cursor-pointer p-2 max-sm:w-[100%] sm:w-[100%] h-[170px] backdrop-blur-lg shadow-md rounded-md">
